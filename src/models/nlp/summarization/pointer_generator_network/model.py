...
import torch
from models.nlp.summarization.LeafNATS.data.summarization.load_single import *
from models.nlp.summarization.LeafNATS.data.utils import construct_vocab
from models.nlp.summarization.LeafNATS.engines.end2end import natsEnd2EndBase
from models.nlp.summarization.LeafNATS.modules.decoder.nats_decoder_pointer_generator import \
    PointerGeneratorDecoder
from models.nlp.summarization.LeafNATS.modules.decoding.word_copy import \
    word_copy
from models.nlp.summarization.LeafNATS.modules.embedding.nats_embedding import \
    natsEmbedding
from models.nlp.summarization.LeafNATS.modules.encoder2decoder.nats_encoder2decoder import \
    natsEncoder2Decoder
from models.nlp.summarization.LeafNATS.modules.encoder.nats_encoder_rnn import \
    natsEncoder
from models.nlp.summarization.LeafNATS.utils.utils import *
...
class modelPointerGenerator(natsEnd2EndBase):
    ...
    def test_worker(self, _nbatch):
        ...
        fout = open(os.path.join('..', 'nats_results',
                                 self.args.file_output), 'w', encoding='utf-8')
